                ...
                <div className="container-fluid bg-light" style={{border: "solid 0.5px", marginTop: "100px"}}>
                    <div className="row">
                        <div className="col-md-5">
                            <img src={"http://localhost:3000/images/" + this.state.image} style={{padding: "20px"}}
                                 width="100%" height="100%"/>
                        </div>
                        <div className="col-md-7">
                            <h4>{this.state.name}</h4>
                            <div className="price"><span className="mr-2">&nbsp;Our Address: {this.state.address}</span><span
                                className="mr-2 cut"></span><span className="text-success">25% OFF</span></div>
                            ...
                            <div className="d-flex align-items-center mt-4 offers mb-1"><i
                                className="fa fa-check-square-o mt-1"></i><span className="ml-1 font-weight-bold">Bank Offers</span><span
                                className="ml-1">20% On Delivery<br/></span></div>
                            <div className="d-flex align-items-center offers mb-1"><i
                                className="fa fa-check-square-o mt-1"></i><span className="ml-1 font-weight-bold">Bank Offers</span><span
                                className="ml-1">Contact:{this.state.phone}<br/></span></div>
                            <div className="d-flex align-items-center offers mb-1"><i
                                className="fa fa-check-square-o mt-1"></i><span className="ml-1 font-weight-bold">Bank Offers</span><span
                                className="ml-1">Extra 5% off* with Axis Bank Buzz Credit Card<br/></span></div>
                            <div className="d-flex align-items-center offers"><i
                                className="fa fa-check-square-o mt-1"></i><span className="ml-1 font-weight-bold">Bank Offers</span><span
                                className="ml-1">{this.state.description}<br/></span></div>
                            <hr/>
                                    ...
                                    <div className="product-grid" style={{height: "250px"}}>
                                        <div className="product-image" style={{height: "300px"}}>
                                            <a href="#" className="image">
                                                <img className="pic-1" style={{height: "200px", marginBottom: "100px"}}
                                            ...
                                            <ul className="product-links">
...

                                                {
                                                    user === "Admin" ? (<>
                                                            <li><a href="#"
                                                                   onClick={this.deleteFood.bind(this, item._id)}><i
                                                                class="fa fa-trash"></i></a></li>


                                                            <li><a href="#"><i class="fa fa-random"
                                                                               onClick={this.goUpdate.bind(this, item._id)}></i></a>
                                                            </li>

                                                        </>)
                                                        : (<>
                                                            <li><a href="#"><i class="fa fa-shopping-cart"
                                                                               onClick={this.book.bind(this, item._id)}></i></a>
                                                            </li>
